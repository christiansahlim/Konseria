...
@Composable
fun DetailOtherConcertsCard(modifier: Modifier, concert: Concerts) {
    Card(
        modifier = modifier
            .width(325.dp)
            .height(200.dp),
...
@Preview
@Composable
fun DetailOtherConcertsCardPreview() {
    KonseriaTheme {
        DetailOtherConcertsCard(modifier = Modifier, concert = dummyCategory[0])
    }
}